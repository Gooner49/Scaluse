...
object kafka_hive_batch
{
    def main(args: Array[String]) : Unit =
    {

          val spk1 = SparkSession.builder().appName("Spark SQL basics").enableHiveSupport().getOrCreate()
          import spk1.implicits._
          val sp1 = spk1.sparkContext  
          val sqlc = spk1.sqlContext
        ...
        //write().mode(SaveMode.Overwrite).saveAsTable("userdb1.kafka_batch");
        sqlc.sql("create table userdb1.kafka_batch as select * from temp_table")
